...
class Binance(object):
    ...
    def _write_file_hdfs(self,data, destination):
        ...
        spark = SparkSession.builder \
            ...
            .getOrCreate()
        try:
            # Chuyển dữ liệu thành chuỗi parquet
    ...
    #             # Thêm cột "symbol" vào từng mục Kline
    #             for kline in klines:
    #                 kline.append(symbol_name)  # Thêm symbol vào cuối danh sách Kline
    #                 data.append(kline)
